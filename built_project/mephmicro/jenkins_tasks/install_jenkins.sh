...
echo "java -jar jenkins-cli.jar -s $JENKINS_URL create-job $BASE_FOLDER$PROJECT_NAME  < ./folder/mephmicro.xml"
java -jar jenkins-cli.jar -s $JENKINS_URL create-job $BASE_FOLDER$PROJECT_NAME  < ./folder/mephmicro.xml
