...
echo "java -jar jenkins-cli.jar -s $JENKINS_URL create-job $BASE_FOLDER$PROJECT_NAME  < ./folder/test.xml"
java -jar jenkins-cli.jar -s $JENKINS_URL create-job $BASE_FOLDER$PROJECT_NAME  < ./folder/test.xml
